...
<html lang="ko">
  ...
  <body>
    ...
    <div class="body__container">
          ...
          <div class="menu-group">
            ...
            >
              <div class="container-fluid">
                <a class="navbar-brand" href="#">Super Ants</a>
                <button
                    ...
                    <li class="nav-item dropdown">
                      ...
                      >
                        <li>
                          <a
                            class="dropdown-item"
                            href="./components/stock-calendar.html"
                            >공모주 일정</a
                          >
                        </li>
                        <li>
                          <a
                            class="dropdown-item"
                            href="./components/inve-inform.html"
                            >투자정보</a
                          >
                        </li>
                        <li>
                          <a
                            class="dropdown-item"
                            href="./components/digi-notice.html"
                            >전자공시</a
                          >
                        </li>
      ...
      <!-- <script>
          window.onload = () => {
            const link = document.querySelectorAll('.root');
            ...
            const linkRouterPush = (pathName, e) => {
              window.history.pushState({}, pathName, window.location.origin + pathName);
              renderHTML(e, routes[pathName]);
            };

            const renderHTML = (e, route) => {
              e.innerHTML = route;
            }
          }
        </script> -->
